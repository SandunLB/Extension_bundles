export const bundleConfig = {
  ...
  'UltimateBundle': {
    ...
    description: 'The complete package with all features for those who demand the best.',
    prices: {
      monthly: { price: '$49.99/month', id: 'price_1Q79IwEUAhHysq2jWpJ8wFXv' },
      yearly: { price: '$499.99/year', id: 'price_1Q79JWEUAhHysq2jOFqMGYsU' },
      lifetime: { price: '$999.99 one-time', id: 'price_1Q79JyEUAhHysq2jtihJTIc4' },
    },
  },
  'CustomBundle': {
    name: 'Custom Bundle',
    extensions: ['CustomTool1', 'CustomTool2'],
    description: 'A tailored solution designed to meet your specific needs and requirements.',
    prices: {
      monthly: { price: '$59.99/month', id: 'price_1Q79IwEUAhHysq2jWpJ8wFXv' },
      yearly: { price: '$599.99/year', id: 'price_1Q79JWEUAhHysq2jOFqMGYsU' },
      lifetime: { price: '$1199.99 one-time', id: 'price_1Q79JyEUAhHysq2jtihJTIc4' },
    },
  },
}